									...
									<div class="profile-box">
										<div class="profile-cover-pic">
											<div class="fileupload btn btn-default">
												<span class="btn-text">Змінити</span>
										...
										<div class="profile-info text-center">
											<div class="profile-img-wrap">
												<img class="inline-block mb-10" src="{$foto1}" alt="user"/>
												<div class="fileupload btn btn-default">
													<span class="btn-text">Змінити</span>
													<input class="upload" type="file">
												</div>
											</div>
											<h5 class="block mt-10 mb-5 weight-500 capitalize-font txt-danger">{$name}</h5>
											<h6 class="block capitalize-font pb-20">{$payement}</h6>
										</div>
										<div class="social-info">
											...
											<button class="btn btn-default btn-block btn-outline btn-anim mt-30" data-toggle="modal" data-target="#myModal"><i class="fa fa-pencil"></i><span class="btn-text">Налаштувати профіль</span></button>
											<div id="myModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
															<h5 class="modal-title" id="myModalLabel">Налаштування профілю</h5>
														</div>
																						...
																						<form method="post">
																							<div class="form-body overflow-hide">
																								<div class="form-group">
																									<label class="control-label mb-10" for="exampleInputuname_1">Ім'я</label>
																									<div class="input-group">
																										<div class="input-group-addon"><i class="icon-user"></i></div>
																										<input type="text" name="name" class="form-control" id="exampleInputuname_1" value="{$name}">
																									</div>
																								</div>
																								<div class="form-group">
																									...
																									<div class="input-group">
																										...
																										<input type="text" name="mail" class="form-control" id="exampleInputEmail_1" value="{$email}">
																									</div>
																								</div>
																								<div class="form-group">
																									<label class="control-label mb-10" for="exampleInputContact_1">Номер телефону</label>
																									<div class="input-group">
																										<div class="input-group-addon"><i class="icon-phone"></i></div>
																										<input type="text" name="telephone" class="form-control" id="exampleInputContact_1" value="{$number}">
																									</div>
																								</div>
																								<div class="form-group">
																									<label class="control-label mb-10" for="exampleInputpwd_1">Пароль</label>
																									<div class="input-group">
																										<div class="input-group-addon"><i class="icon-lock"></i></div>
																										<input type="password" name = "password" class="form-control" id="exampleInputpwd_1" value="{$password}">
																									</div>
																								</div>
																								<div class="form-group">
																									<label class="control-label mb-10">Стать</label>
																									<div>
																										<div class="radio">
																								...
																								<div class="form-group">
																									<label class="control-label mb-10">Країна</label>
																									<select class="form-control" name="select" data-placeholder="Choose a Category" tabindex="1">
																										<option value="Category 1">Україна</option>
																										<option value="Category 2">Austrailia</option>
																										<option value="Category 3">India</option>
																										<option value="Category 4">UK</option>
                                                    <option value="Category 5">USA</option>
																									</select>
																								</div>
																							</div>
																							<div class="form-actions mt-10">
																								<button type="submit" name="save" class="btn btn-success mr-10 mb-30">Оновити данні профілю</button>
																							</div>
																						</form>
																					</div>
																				</div>
														...
														<div class="modal-footer">
															<button type="button" class="btn btn-success waves-effect" data-dismiss="modal">Зберегти</button>
															<button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Скасувати</button>
														</div>
													</div>
													<!-- /.modal-content -->
												</div>
