...
<body>
    ...
    <div class="wrapper theme-4-active pimary-color-red">
			...
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							...
							<span class="brand-text">f-profy</span>
						</a>
					</div>
				</div>
				...
				<form id="search_form" role="search" class="top-nav-search collapse pull-left">
					<div class="input-group">
						<input type="text" name="example-input1-group2" class="form-control" placeholder="Пошук">
				...
				<ul class="nav navbar-right top-nav pull-right">
						...
						<ul  class="dropdown-menu alert-dropdown" data-dropdown-in="bounceIn" data-dropdown-out="bounceOut">
							<li>
								<div class="notification-box-head-wrap">
									<span class="notification-box-head pull-left inline-block">Сповіщення</span>
									<a class="txt-danger pull-right clear-notifications inline-block" href="javascript:void(0)"> Видалити всі </a>
									<div class="clearfix"></div>
									<hr class="light-grey-hr ma-0"/>
								</div>
							</li>
							...
							<li>
								<div class="notification-box-bottom-wrap">
									<hr class="light-grey-hr ma-0"/>
									<a class="block text-center read-all" href="javascript:void(0)"> Прочитати всі </a>
									<div class="clearfix"></div>
								</div>
							</li>
						</ul>
					...
					<li class="dropdown auth-drp">
						...
						<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							<li>
								<a href="?mod=usersset"><i class="zmdi zmdi-account"></i><span>Профіль</span></a>
							</li>
							<li>
								<a href="?mod=usersset"><i class="zmdi zmdi-card"></i><span>Баланс</span></a>
							</li>
							<li>
								<a href="inbox.html"><i class="zmdi zmdi-email"></i><span>повідомлення</span></a>
							</li>


							<li class="divider"></li>
							<li>
								<a href="?mod=logout"><i class="zmdi zmdi-power"></i><span>Вийти</span></a>
							</li>
						</ul>
					</li>
				</ul>
        ...
        <li>
					<a href="?mod=home"><div class="pull-left"><i class="zmdi zmdi-home mr-20"></i><span class="right-nav-text">Головна</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
				</li>
			...
			<!--	<li>
				...
				<li>
					<a href="?mod=app"><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Програми</span></div><div class="pull-right"><span class="label label-danger">new</span></div><div class="clearfix"></div></a>
				</li>
				<li><hr class="light-grey-hr mb-10"/></li>
				<li class="navigation-header">
					<span>Адмін меню</span>
					<i class="zmdi zmdi-more"></i>
          <li>
  					<a href="?mod=homeadm"><div class="pull-left"><i class="zmdi zmdi-home mr-20"></i><span class="right-nav-text">Головна</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
  				</li>
          <li>
  					<a href="?mod=editusers"><div class="pull-left"><i class="zmdi zmdi-home mr-20"></i><span class="right-nav-text">Користувачі</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
  				</li>
          <li>
  					<a href="?mod=addapp"><div class="pull-left"><i class="zmdi zmdi-home mr-20"></i><span class="right-nav-text">Додати програму</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
  				</li>
